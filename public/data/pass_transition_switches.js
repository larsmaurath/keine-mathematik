...
svg.append("text")
  ...
  .text("Toni Kroos Pass-Heatmap (Pässe über 35m in die Breite)");
...
svg.selectAll(".zone")
  .on("mouseover", function(d, i) {
    ...
    svg.selectAll(".title")
      .text("Toni Kroos Pass-Heatmap - " + format(select_ratio).toString() + "% aller Pässe beginnen in diesem Rechteck");
