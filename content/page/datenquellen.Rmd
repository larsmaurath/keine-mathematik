...
Dieser Artikel versucht eine Liste von frei verfügbaren Datensätzen zu sammeln um Interessierten den Einstieg zu erleichtern. Falls du einen Vorschlag hast der unten noch nicht aufgeführt ist lass es uns gerne [wissen](https://www.keinemathematik.de/page/mitmachen/){target="_blank"}.
...
![*Top 10 Spieler nach xG - Bundesliga 2019/2020 (fbref.com)*](/page/datenquellen_files/fbref.png)
...
![*Top 10 des Global Club Soccer Rankings - April 2020 (fivethirtyeight.com)*](/page/datenquellen_files/fivethirtyeight.png)

***

# [Metrica Sports](https://metrica-sports.com/){target="_blank"}

Metrica Sports hat dieses Jahr den ersten frei verfügbaren [Trackingdatensatz](https://github.com/metrica-sports/sample-data){target="_blank"} veröffentlicht. Er umfasst zwei anonymisierte Spiele und gibt erste Einblicke was mit detaillierten Trackingdaten alles möglich ist.
...
Ein Grund für den großen Einfluss von Statsbomb sind meiner Meinung nach die vielen Kommunikationskanäle mit der das Team mit Profis und Hobbyanalysten in Verbindung tritt: Twitter, ihre Webseite mit vielen Blogartikeln, ihre Podcast, ihre [Konferenz](https://statsbomb.com/conference/){target="_blank"}. Statsbomb war meines Wissens auch das erste Unternehmen dass das Teilen von Daten als Teil seiner Kultur sieht. 
...
- Metrica Sports: [Trackingdatensatz](https://github.com/metrica-sports/sample-data){target="_blank"}
- Statsbomb: [Eventdatensätze](https://github.com/statsbomb/open-data){target="_blank"}
- WyScout: [Eventdatensätze](https://figshare.com/collections/Soccer_match_event_dataset/4415000/5){target="_blank"}
