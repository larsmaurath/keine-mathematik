...
<meta name="twitter:description" content="Expected Goals (erwartete Tore) oder auch xG ist eine Statistik, die versucht die Qualität eines Torschußes in einem einzigen Wert zusammenzufassen. So hilft sie dabei eine vom Ergebnis unabhängige Aussage über die Leistung beider Teams (oder auch einzelner Spieler) zu treffen. ">
...
Das Finale 1966 ist durch sehr viele Torschüsse geprägt und bis zur 70. Minute sehr ausgeglichen. Dann erarbeiten sich die Engländer ein Chancenvorteil und in der 78. Minute auch die Führung. 
...
Doch auch in der Verlängerung bleibt England die bessere Mannschaft, bis in der 101. Minute das berühmte Wembleytor durch Hurst fällt. Deutschland schafft es nicht mehr gefährlich vors Tor und muss in der 120. Minute auch noch das 4:2 hinnehmen. England ist Weltmeister und nach xG auch verdient: **1.91 - 1.47**
...
- Bundeliga [Erklärung](https://www.bundesliga.com/de/bundesliga/news/expected-goals-xgoals-fussball-analyse-statistik-3760){target="_blank"} des *expected Goals*-Konzepts
- [Tutorial](https://www.thesignificantgame.com/portfolio/expected-goals-model-with-tidymodels/) für Implementierung von expected Goals-Modell in R
- Falls ihr Vorschläge für weitere deutsche Klassiker habt schreibt gerne unten in die Kommentare
